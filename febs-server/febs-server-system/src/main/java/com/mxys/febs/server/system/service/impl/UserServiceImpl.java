package com.mxys.febs.server.system.service.impl;
...
import com.mxys.febs.server.system.mapper.UserMapper;
import com.mxys.febs.server.system.service.IUserRoleService;
...
@Service
@Transactional(propagation = Propagation.SUPPORTS,readOnly = true,rollbackFor = Exception.class)//@Transactional注解用于开启数据库事务
